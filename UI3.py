import threading
import time
from customtkinter import CTk, CTkFrame, CTkLabel, CTkButton, CTkFont, CTkCanvas, CTkInputDialog
...
class App(CTk):
    def __init__(self):
        ...
        self.monitor_thread = threading.Thread(target=self.monitor_camera, daemon=True)
